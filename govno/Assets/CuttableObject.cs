...
public class CuttableShape : MonoBehaviour
{
    ...
    private CutValidator localValidator; // Ссылка на собственный валидатор

    private void Start()
    {
        mainCamera = Camera.main;

        // Пытаемся найти валидатор на этом же объекте или внутри него
    ...
    private IEnumerator AnimateCutAndSpawn()
    {
        ...
        // Важное изменение: используем ЛОКАЛЬНЫЙ валидатор, привязанный конкретно к этой форме
